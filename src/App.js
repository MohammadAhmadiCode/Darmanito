    ...
    return (
      <Router>
        <Fragment>
          <Navbar />
          <Switch>
            <Route path="/Darmanito" component={Main} />
            ...
            <Route
              exact
              path="/RegisterPharmacy/Register"
              component={RegisterPharmacyRegister}
            />
            <Route
              exact
              path="/RegisterPharmacy/Register/Detail"
              component={RegisterPharmacyDetail}
            />
            <Route
              exact
              path="/RegisterPharmacy/Register/Detail/Confirm"
              component={RegisterPharmacyConfirm}
            />
